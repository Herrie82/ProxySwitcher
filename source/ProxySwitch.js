enyo.kind({
  ...
  components: [
	...
	{kind: "Button", style: "width: 350px;", align: "center", caption: "Turn Proxy On", onclick: "btnAddClick"},
    {kind: "Button", style: "width: 350px;", align: "center",caption: "Turn Proxy Off", onclick: "btnRmvClick"},
  
   	{name: "ReturnValue", 
	 kind:"Control", 
 content: "", style: "width: 350px; text-align: center; padding: 10px; margin-top: 20px; border-radius: 7px;"},
...
btnAddClick: function() {
  	...
  	this.$.addProxy.call({"action":"add", "proxyInfo":{"proxyConfigType":"manualProxy","proxyScope":"default","proxyServer":this.$.proxyURL.getValue(),"proxyPort":parseInt(this.$.proxyPort.getValue())}  });	
...
btnRmvClick: function() {
  	...
  	this.$.rmvProxy.call({"action":"rmv", "proxyInfo":{"proxyScope":"default"}  });	
...
setPrefs : function()
{
    this.$.setPreferencesCall.call({"defaultProxy":this.$.proxyURL.getValue(), "defaultPort":this.$.proxyPort.getValue()});
},
